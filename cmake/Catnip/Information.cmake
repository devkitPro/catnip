...
if(NOT DEFINED CATNIP_BUILD_DIR)
	if(DEFINED ENV{CATNIP_BUILD_DIR})
		get_filename_component(CATNIP_BUILD_DIR "$ENV{CATNIP_BUILD_DIR}" ABSOLUTE BASE_DIR "${CATNIP_ROOT}")
	else()
		set(CATNIP_BUILD_DIR ${CATNIP_ROOT}/build)
	endif()
else()
	get_filename_component(CATNIP_BUILD_DIR "${CATNIP_BUILD_DIR}" ABSOLUTE BASE_DIR "${CATNIP_ROOT}")
endif()
